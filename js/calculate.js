...
$('#calculate').click(function (e) {
	...
	const vacioPagar = totalPagar === 0 || totalPagar === '';
	const vacioCantidad = valorCantidad === 0 || valorCantidad === '';

	if(vacioPagar) {
		$('#cambio').append(`<b>El PRECIO, no puede estar vacio</b>`);
	}
	else if(vacioCantidad) {
		$('#cambio').append(`<b>El EFECTIVO, no puede estar vacio</b>`);
	} else {
